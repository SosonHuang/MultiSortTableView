...
- (UIView *)addVerticalLineWithWidth:(CGFloat)width bgColor:(UIColor *)color atX:(CGFloat)x atY:(CGFloat)y {
    
    
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(x, y , width, self.bounds.size.height)];
